...
@CucumberOptions(
		...
		features = {".//FeatureFilesPhilippines/01_HomePage.feature",".//FeatureFilesPhilippines/02_ZambiaBikeFeature.feature",".//FeatureFilesPhilippines/03_Dealer.feature",
		...
		monochrome = true,
		tags = "@HomePage",       //scenarios under @sanity tag will be executed "@AdminLogin or @Sanity",
